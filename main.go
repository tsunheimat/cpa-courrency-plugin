...
func pluginRegistration() registration {
	return registration{SchemaVersion: pluginabi.SchemaVersion, Metadata: pluginapi.Metadata{Name: pluginID, Version: "0.1.7", Author: "tsunheimat", GitHubRepository: "https://github.com/tsunheimat/cpa-courrency-plugin", ConfigFields: []pluginapi.ConfigField{
